    ...
    <section className='contact section'>
      ...
      <div className="contact__container container grid">
        <div className="contact__data">
          ...
          <p className="contact__description">Feel free to get in touch with me. I am always open to discussing new projects, creative ideas or opportunities to be part of your visions
          </p>
          <div className="contact__info">
            ...
            <div>
              ...
              <h4 className="info_-desc">godwin5867@mail</h4>
            </div>
            </div>
            ...
            <div>
              ...
              <h4 className="info_-desc">+2349024543855</h4>
            </div>
            </div>
          </div>
